...
public class TestRun {
	public static void main(String[] args) {
		...
		Parent p2 = new Parent("김","서울시 어딘가",2000,"G80"); //매개변수 생성자
		
		System.out.println("------------------------------------------");
		Child1 c1 = new Child1(); //자식1 기본생성자
		
		//Child1 자식의 기능
		c1.setComputer("삼성 갤럭시북4");
		
		//Child1 내부에 생성된 parent 의 기능
		...
		Child2 c3 = new Child2("최", "서울시 강남구", 999999999, "벤츠", "아이폰15");
		...
		//오버라이딩 확인하기
		System.out.println("----------------------------------------------------");
		System.out.println(ch1.introduce()); //재정의
		System.out.println(ch2.introduce()); //재정의
...
//		edu.kh.inheritance.model.dto2.Child2@6442b0a6
		...
		// Parent 오버라이딩 후
		// 오버라이딩 된 Parent의 toString()을 Child1/2가 상속 받음
