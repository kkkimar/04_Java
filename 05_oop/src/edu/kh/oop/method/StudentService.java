...
0. 프로그램 종료
	...
	private Student createStudent() {
		...
		//-> sc.next()로 입력 받은 문자열 중 0인덱스 번째 문자 하나를
		//	반환 받아 gender 변수에 저장
	...
	private String studentInform(Student s) {
		...
		//KH대학교 / 123123 / 남 / 홍길동 / jave / html
		return String.format("%s / %s / %c / %s / %d / %d", 
				Student.shoolName, s.getStudentNumber(), s.getGender(),s.getName(), s.getJava(),s.getHtml());
	 ...
	 *  
	 *  ex) Java 역량이 120인 경우 100(최대값으로 표현)
	 *  		Java 역량이 -30인 경우 0(최소값으로 표현)
	 *  
	 * @param s
	 */
