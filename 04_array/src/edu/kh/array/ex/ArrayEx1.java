...
public class ArrayEx1 {
	...
	public void method1() {
		...
		//변수 선언
		int num;
		//-> stack영역에 int 자료형을 저장할 수 있는 변수를 생성하고
		//   그 변수의 이름을 num으로 지정
		
		//배열 선언
		int[] arr;
		//-> stack영역에 int[] 자료형을 참조할 변수를 생성 (주소저장)
		//	 그 변수의 이름을 "arr"으로 지정
		...
		/*[이클립스 디버그 모드 사용 방법]
		 * 
		 * 1) 확인하고 싶은 코드 다음 줄에 break point를 추가
		 * 
		 * 2) debug 모드로 실행 (벌레 아이콘 또는 F11)
		 * 
		 * 3) debug 화면으로 switch
		 * 
		 * 4) resume (F8키)를 눌러가며 순서대로 확인
		 * */
	...
	public void method3() {
		...
		//과목이 작성되어 있는 배열 생성
		String[] subjects = {"Java","HTML","CSS","JavaScript"}; //length = 4
	...
	public void method4() {
		...
		for(int i = 0; i < randoms.length; i++) {
			randoms[i] = (int)( Math.random() * len ); //double을 int로 강제형변환
			                                           //데이터 손실을 이용한 소수점 제거
		}
