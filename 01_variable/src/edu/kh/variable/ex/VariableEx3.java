...
public class VariableEx3 {
	public static void main(String[] args) {
		...
		System.out.println(num3/num4); // 5/1 == 2.5 but 값처리 원칙이 우선 적용으로  2 가 나옴
		System.out.println((double)(num3/num4)); //2.0
		System.out.println((double)num3/(double)num4); //2.5
		                    //    5.0 / 2.0 == (double) 2.5
		
		/*강제 형변환 + 자동형변환 + 값 처리 원칙*/
		System.out.println((double)num3/num4); //2.5
		// (double)(int) 5 / int 2  
		// double 5.0 / int 2 -> 강제형변환 
		// double 5.0 / double 2.0 -> 자동형변환 
		// double 5.0 / double 2.0 -> 값 처리 원칙으로 double 2.5
		...
		byte temp1 = 127; //byte는 처음 대입할때 int
