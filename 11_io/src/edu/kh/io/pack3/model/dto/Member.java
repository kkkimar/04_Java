...
// 직렬화(Serialiazable) : 객체를 직선 형태로 변형

// 직렬화 방법!! => Serialiazable 인터페이스를 상속 받으면 끝 ! 

/*Serialiazable 인터페이스
 * - 추상 메서드가 하나도 없는 인터페이스
 * - 상속만 받아도 
 * 	 입/출력 시 직렬화가 가능하다는 의미만 제공
 *   --> 마커 인터페이스
 * 
 * */
...
public class Member implements Serializable{
 ...
 //getter / setter (필드 간접 접근 방법)
	...
	public String toString() {
		return "Member [id=" + id + ", pw=" + pw + ", name=" + name + ", age=" + age + ", getId()=" + getId() + ", getPw()="
				+ getPw() + ", getName()=" + getName() + ", getAge()=" + getAge() + ", getClass()=" + getClass()
