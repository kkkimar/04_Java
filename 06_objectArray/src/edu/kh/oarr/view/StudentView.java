...
public class StudentView {
	...
	public void displayMenu() {
		...
		do {
			...
			System.out.println("4. 학생 이름으로 조회"); // 동명이인 없다 가정
	...
	private void selectName() {
		...
		if(std == null) System.out.println("해당 이름의 학생이 존재하지 않습니다");
	...
	private void updateStudent() {
		...
		//HTML , CSS, JS, Java 점수를 입력 받아 바로 std에 세팅
